                    ...
                    <div id="container" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div id="section">
                                    ...
                                    <div class="exp-all">
                                        <div class="campos-form">
                                            ...
                                            <div class="campos-form">
                                                ...
                                                <input id="new-ema" name="new-ema" class="campoEmail i-update input-update" type="email" placeholder="Nuevo Correo">
                                                <input id="new-cema" name="new-cema" class="campoEmail i-update input-update" type="email" placeholder="Confirnar Nuevo Correo">
                            ...
                            <div id="div-delete-account">
                                <input id="delete-account" type="button" value="Eliminar Cuenta">
                            </div>
                        </div>
                    </div>
                </div>
